...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'dizda.cloudbackup.client.cloudapp' => 'getDizda_Cloudbackup_Client_CloudappService',
            'dizda.cloudbackup.client.dropbox' => 'getDizda_Cloudbackup_Client_DropboxService',
            'dizda.cloudbackup.client.dropbox_sdk' => 'getDizda_Cloudbackup_Client_DropboxSdkService',
            'dizda.cloudbackup.client.gaufrette' => 'getDizda_Cloudbackup_Client_GaufretteService',
            'dizda.cloudbackup.client.local' => 'getDizda_Cloudbackup_Client_LocalService',
            'dizda.cloudbackup.database.mongodb' => 'getDizda_Cloudbackup_Database_MongodbService',
            'dizda.cloudbackup.database.mysql' => 'getDizda_Cloudbackup_Database_MysqlService',
            'dizda.cloudbackup.database.postgresql' => 'getDizda_Cloudbackup_Database_PostgresqlService',
            'dizda.cloudbackup.manager.backup' => 'getDizda_Cloudbackup_Manager_BackupService',
            'dizda.cloudbackup.manager.client' => 'getDizda_Cloudbackup_Manager_ClientService',
            'dizda.cloudbackup.manager.database' => 'getDizda_Cloudbackup_Manager_DatabaseService',
            'dizda.cloudbackup.manager.processor' => 'getDizda_Cloudbackup_Manager_ProcessorService',
            'dizda.cloudbackup.processor.7z' => 'getDizda_Cloudbackup_Processor_7zService',
            'dizda.cloudbackup.processor.tar' => 'getDizda_Cloudbackup_Processor_TarService',
            'dizda.cloudbackup.processor.zip' => 'getDizda_Cloudbackup_Processor_ZipService',
            'dizda.cloudbackup.splitter.zip' => 'getDizda_Cloudbackup_Splitter_ZipService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/winnick/api/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/winnick/api/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/winnick/api/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/winnick/api/app/Resources');
    ...
    /**
     * Gets the 'dizda.cloudbackup.client.cloudapp' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Client\CloudAppClient A Dizda\CloudBackupBundle\Client\CloudAppClient instance.
     */
    protected function getDizda_Cloudbackup_Client_CloudappService()
    {
        return $this->services['dizda.cloudbackup.client.cloudapp'] = new \Dizda\CloudBackupBundle\Client\CloudAppClient(array('dropbox_sdk' => array('remote_path' => '/Applications/winnick', 'access_token' => 'VyCtbShGzyIAAAAAAAB132E-dYQHSF-TwqFR0d8GMnFuyuPWv4kL_Lji4Wiu6jn-')));
    }

    /**
     * Gets the 'dizda.cloudbackup.client.dropbox' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Client\DropboxClient A Dizda\CloudBackupBundle\Client\DropboxClient instance.
     */
    protected function getDizda_Cloudbackup_Client_DropboxService()
    {
        return $this->services['dizda.cloudbackup.client.dropbox'] = new \Dizda\CloudBackupBundle\Client\DropboxClient(array('dropbox_sdk' => array('remote_path' => '/Applications/winnick', 'access_token' => 'VyCtbShGzyIAAAAAAAB132E-dYQHSF-TwqFR0d8GMnFuyuPWv4kL_Lji4Wiu6jn-')));
    }

    /**
     * Gets the 'dizda.cloudbackup.client.dropbox_sdk' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Client\DropboxSdkClient A Dizda\CloudBackupBundle\Client\DropboxSdkClient instance.
     */
    protected function getDizda_Cloudbackup_Client_DropboxSdkService()
    {
        return $this->services['dizda.cloudbackup.client.dropbox_sdk'] = new \Dizda\CloudBackupBundle\Client\DropboxSdkClient(array('dropbox_sdk' => array('remote_path' => '/Applications/winnick', 'access_token' => 'VyCtbShGzyIAAAAAAAB132E-dYQHSF-TwqFR0d8GMnFuyuPWv4kL_Lji4Wiu6jn-')));
    }

    /**
     * Gets the 'dizda.cloudbackup.client.gaufrette' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Client\GaufretteClient A Dizda\CloudBackupBundle\Client\GaufretteClient instance.
     */
    protected function getDizda_Cloudbackup_Client_GaufretteService()
    {
        return $this->services['dizda.cloudbackup.client.gaufrette'] = new \Dizda\CloudBackupBundle\Client\GaufretteClient();
    }

    /**
     * Gets the 'dizda.cloudbackup.client.local' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Client\LocalClient A Dizda\CloudBackupBundle\Client\LocalClient instance.
     */
    protected function getDizda_Cloudbackup_Client_LocalService()
    {
        return $this->services['dizda.cloudbackup.client.local'] = new \Dizda\CloudBackupBundle\Client\LocalClient(array('dropbox_sdk' => array('remote_path' => '/Applications/winnick', 'access_token' => 'VyCtbShGzyIAAAAAAAB132E-dYQHSF-TwqFR0d8GMnFuyuPWv4kL_Lji4Wiu6jn-')));
    }

    /**
     * Gets the 'dizda.cloudbackup.database.mongodb' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Database\MongoDB A Dizda\CloudBackupBundle\Database\MongoDB instance.
     */
    protected function getDizda_Cloudbackup_Database_MongodbService()
    {
        $this->services['dizda.cloudbackup.database.mongodb'] = $instance = new \Dizda\CloudBackupBundle\Database\MongoDB(array('mysql' => array('all_databases' => false, 'database' => 'winnick', 'db_host' => '127.0.0.1', 'db_port' => 3306, 'db_user' => 'root', 'db_password' => NULL, 'ignore_tables' => array())), 'C:/wamp/www/winnick/api/app/cache/dev/backup/');

        $instance->setTimeout(300);

        return $instance;
    }

    /**
     * Gets the 'dizda.cloudbackup.database.mysql' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Database\MySQL A Dizda\CloudBackupBundle\Database\MySQL instance.
     */
    protected function getDizda_Cloudbackup_Database_MysqlService()
    {
        $this->services['dizda.cloudbackup.database.mysql'] = $instance = new \Dizda\CloudBackupBundle\Database\MySQL(array('mysql' => array('all_databases' => false, 'database' => 'winnick', 'db_host' => '127.0.0.1', 'db_port' => 3306, 'db_user' => 'root', 'db_password' => NULL, 'ignore_tables' => array())), 'C:/wamp/www/winnick/api/app/cache/dev/backup/');
    ...
    /**
     * Gets the 'dizda.cloudbackup.database.postgresql' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Database\PostgreSQL A Dizda\CloudBackupBundle\Database\PostgreSQL instance.
     */
    protected function getDizda_Cloudbackup_Database_PostgresqlService()
    {
        $this->services['dizda.cloudbackup.database.postgresql'] = $instance = new \Dizda\CloudBackupBundle\Database\PostgreSQL(array('mysql' => array('all_databases' => false, 'database' => 'winnick', 'db_host' => '127.0.0.1', 'db_port' => 3306, 'db_user' => 'root', 'db_password' => NULL, 'ignore_tables' => array())), 'C:/wamp/www/winnick/api/app/cache/dev/backup/');
    ...
    /**
     * Gets the 'dizda.cloudbackup.manager.backup' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Manager\BackupManager A Dizda\CloudBackupBundle\Manager\BackupManager instance.
     */
    protected function getDizda_Cloudbackup_Manager_BackupService()
    {
        return $this->services['dizda.cloudbackup.manager.backup'] = new \Dizda\CloudBackupBundle\Manager\BackupManager($this->get('logger'), $this->get('dizda.cloudbackup.manager.database'), $this->get('dizda.cloudbackup.manager.client'), $this->get('dizda.cloudbackup.manager.processor'), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'dizda.cloudbackup.manager.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Manager\ClientManager A Dizda\CloudBackupBundle\Manager\ClientManager instance.
     */
    protected function getDizda_Cloudbackup_Manager_ClientService()
    {
        $this->services['dizda.cloudbackup.manager.client'] = $instance = new \Dizda\CloudBackupBundle\Manager\ClientManager($this->get('logger'));

        $instance->add($this->get('dizda.cloudbackup.client.dropbox_sdk'));

        return $instance;
    }

    /**
     * Gets the 'dizda.cloudbackup.manager.database' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Manager\DatabaseManager A Dizda\CloudBackupBundle\Manager\DatabaseManager instance.
     */
    protected function getDizda_Cloudbackup_Manager_DatabaseService()
    {
        $this->services['dizda.cloudbackup.manager.database'] = $instance = new \Dizda\CloudBackupBundle\Manager\DatabaseManager($this->get('logger'));

        $instance->add($this->get('dizda.cloudbackup.database.mysql'));

        return $instance;
    }

    /**
     * Gets the 'dizda.cloudbackup.manager.processor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Manager\ProcessorManager A Dizda\CloudBackupBundle\Manager\ProcessorManager instance.
     */
    protected function getDizda_Cloudbackup_Manager_ProcessorService()
    {
        $this->services['dizda.cloudbackup.manager.processor'] = $instance = new \Dizda\CloudBackupBundle\Manager\ProcessorManager('C:/wamp/www/winnick/api/app/../', 'C:/wamp/www/winnick/api/app/cache/dev/backup/', 'Jonathan-PC', array('type' => '7z', 'date_format' => 'Y-m-d_H-i-s', 'options' => array('password' => NULL, 'compression_ratio' => 6, 'split' => array('enable' => false, 'split_size' => NULL, 'storages' => array()))), array());

        $instance->setProcessor($this->get('dizda.cloudbackup.processor.7z'));

        return $instance;
    }

    /**
     * Gets the 'dizda.cloudbackup.processor.7z' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Processor\SevenZipProcessor A Dizda\CloudBackupBundle\Processor\SevenZipProcessor instance.
     */
    protected function getDizda_Cloudbackup_Processor_7zService()
    {
        $this->services['dizda.cloudbackup.processor.7z'] = $instance = new \Dizda\CloudBackupBundle\Processor\SevenZipProcessor();

        $instance->addOptions(array('password' => NULL, 'compression_ratio' => 6, 'split' => array('enable' => false, 'split_size' => NULL, 'storages' => array())));

        return $instance;
    }

    /**
     * Gets the 'dizda.cloudbackup.processor.tar' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Processor\TarProcessor A Dizda\CloudBackupBundle\Processor\TarProcessor instance.
     */
    protected function getDizda_Cloudbackup_Processor_TarService()
    {
        $this->services['dizda.cloudbackup.processor.tar'] = $instance = new \Dizda\CloudBackupBundle\Processor\TarProcessor();
    ...
    /**
     * Gets the 'dizda.cloudbackup.processor.zip' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Processor\ZipProcessor A Dizda\CloudBackupBundle\Processor\ZipProcessor instance.
     */
    protected function getDizda_Cloudbackup_Processor_ZipService()
    {
        $this->services['dizda.cloudbackup.processor.zip'] = $instance = new \Dizda\CloudBackupBundle\Processor\ZipProcessor();
    ...
    /**
     * Gets the 'dizda.cloudbackup.splitter.zip' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dizda\CloudBackupBundle\Splitter\ZipSplitSplitter A Dizda\CloudBackupBundle\Splitter\ZipSplitSplitter instance.
     */
    protected function getDizda_Cloudbackup_Splitter_ZipService()
    {
        return $this->services['dizda.cloudbackup.splitter.zip'] = new \Dizda\CloudBackupBundle\Splitter\ZipSplitSplitter(NULL);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'winnick', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_6690a35848075b82042ecee0f3b85b6636dfbe4d701304ba6288f45227876160');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_6690a35848075b82042ecee0f3b85b6636dfbe4d701304ba6288f45227876160');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6690a35848075b82042ecee0f3b85b6636dfbe4d701304ba6288f45227876160');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\winnick\\api\\src\\App\\AppBundle\\Entity')), 'App\\AppBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('AppBundle' => 'App\\AppBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/wamp/www/winnick/api/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/winnick/api/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/winnick/api/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/winnick/api/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/winnick/api/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/winnick/api/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/winnick/api/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/winnick/api/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/winnick/api/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/winnick/api/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/winnick/api/app', 'UTF-8'));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\wamp\\www\\winnick\\api\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/winnick/api/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/winnick/api/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/winnick/api/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/winnick/api/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/winnick/api/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/winnick/api/app/logs',
            'kernel.bundles' => array(
                ...
                'AppBundle' => 'App\\AppBundle\\AppBundle',
                'DizdaCloudBackupBundle' => 'Dizda\\CloudBackupBundle\\DizdaCloudBackupBundle',
            ...
            'debug.container.dump' => 'C:/wamp/www/winnick/api/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/winnick/api/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/winnick/api/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/winnick/api/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/winnick/api/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/winnick/api/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/winnick/api/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/winnick/api/app/../web',
            'assetic.write_to' => 'C:/wamp/www/winnick/api/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/winnick/api/app/cache/dev/doctrine/orm/Proxies',
            ...
            'dizda_cloud_backup.root_folder' => 'C:/wamp/www/winnick/api/app/../',
            'dizda_cloud_backup.output_folder' => 'C:/wamp/www/winnick/api/app/cache/dev/backup/',
            'dizda_cloud_backup.processor' => array(
                'type' => '7z',
            ...
            'dizda_cloud_backup.cloud_storages' => array(
                'dropbox_sdk' => array(
                    'remote_path' => '/Applications/winnick',
                    'access_token' => 'VyCtbShGzyIAAAAAAAB132E-dYQHSF-TwqFR0d8GMnFuyuPWv4kL_Lji4Wiu6jn-',
                ),
            ),
            'dizda_cloud_backup.databases' => array(
                'mysql' => array(
                    'all_databases' => false,
                    'database' => 'winnick',
                    'db_host' => '127.0.0.1',
            ...
            'dizda_cloud_backup.output_file_prefix' => 'Jonathan-PC',
            'dizda_cloud_backup.timeout' => 300,
            'dizda_cloud_backup.folders' => array(
